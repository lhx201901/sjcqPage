...
var index_nav = {
	//
	PICURI:"http://192.168.1.195:8083/photo/upload/DATA/",
//	PICURI:"http://192.168.1.178:8083/photo/upload/DATA/",
	//PICURI:"/sjcq/DATA/",

    init:function(){
    	index_nav.searchNewsType('active');
    	getSessoin();
        if(USRSESSION!=null){
...
//                localStorage.setItem('user',"");//刷新localStorage
    ...
    user_jump:function(){
        ...
        window.location.href="../../vision/html/user_uploadImg.html";
    },
    /**
     * 点击搜索框 按钮
     */
     ...
     * @param qx_search 区县
     */
    search_a:function(inp_search,sel_cls,qx_search){
        if(inp_search==null||inp_search==""||inp_search==undefined||inp_search=="undefined"){
            inp_search = "";
        }
        if(sel_cls==null||sel_cls==""||sel_cls==undefined||sel_cls=="undefined"){
        ...
        window.location.href="pictureList.html?inp_search="+inp_search+"&sel_cls="+sel_cls+"&qx_search="+qx_search;
    },
     /**
     * 通过按钮 打开图集列表页
     * @param inp_search 全文搜索值

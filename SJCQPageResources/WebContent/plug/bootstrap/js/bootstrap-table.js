...
(function ($) {
    ...
    BootstrapTable.prototype.removeByUniqueId1 = function (id) {
        var len = this.options.data.length,
            row = this.getRowByUniqueId(id);

        if (row) {
        	for(var i=0;i<this.options.data.length;i++){
        		if(this.options.data[i]==row){
        			this.options.data.splice(i, 1);
        		}
        	}
        }
    ...
    var allowedMethods = [
        ...
        'insertRow', 'updateRow', 'updateCell', 'updateByUniqueId', 'removeByUniqueId','removeByUniqueId1',

...
var modifyImg={
		...
		loadData:function(){
			var  param= modifyImg.paramObj;
			var picXh=param.picXh;
		    $.ajax({
		...
		saveModifyInmg:function(){
			...
			// 按钮
				...
				//修改图片信息
				 $.ajax({
					 	url:"/sjcq/photoPicManage/contributorPicUpdate",
			           // url:"/sjcq/photoPic/editPic",    // 请求的url地址
